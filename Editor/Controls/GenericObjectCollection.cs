...
namespace UnityForms
{
    ...
    public class GenericObjectCollection<T> : IList<T>, ICollection<T>, IEnumerable<T>
    {
        ...
        public event EventHandler<GenericObjectCollectionEventArgs<T>> Changed;
        ...
        {
            if (Added != null) Added(this, new GenericObjectCollectionEventArgs<T>(addedObject));
            OnChanged( addedObject );
        }
        ...
        protected virtual void OnChanged(T changedObject)
        {
            if (Changed != null) Changed(this, new GenericObjectCollectionEventArgs<T>(changedObject));
        }

        protected virtual void OnRemoved(T removedObject)
        {
            if (Removed != null) Removed(this, new GenericObjectCollectionEventArgs<T>(removedObject));
            OnChanged( removedObject);
        }
        ...
        public T this[int index]
        {
            ...
            set
            {
                var oldValue = _dataContainer[index];
